...
public class EditTemplateViewModel extends ViewModel {
    ...
    public void setImageToDish(int dishId, String imageSrc) {
        serverApi.setImageToDish(new SetImageToDishRequest(dishId, imageSrc)).enqueue(new Callback<SimpleResponceModel>() {
            @Override
            public void onResponse(Call<SimpleResponceModel> call, Response<SimpleResponceModel> response) {
